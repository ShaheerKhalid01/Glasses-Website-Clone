...
export default function WomenEyeglasses() {
      ...
      <div className="bg-white py-3 border-b border-gray-200">
        <div className="container mx-auto px-4">
          <div className="text-sm text-gray-600">
            ...
            <span className="text-gray-900 font-medium">Women Eyeglasses</span>
          </div>
        </div>
      </div>

      {/* Women Eyeglasses Banner Section */}
      <div className="bg-gradient-to-br from-amber-100 via-orange-100 to-yellow-100 py-12 md:py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-base md:text-lg text-gray-700 max-w-5xl mx-auto leading-relaxed">
            Make a glamorous statement with our wide range of glasses frames for girls. One place for all the top brands, hot trends and exclusive eyewear styles, find the perfect eyeglasses that enhance your look. You can also find one of our best goggles for girls collection in Pakistan. Place an order now of stylish glasses for girls and get special discount.
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 md:gap-8 lg:gap-12">
            {[
              ...
              { name: 'Gucci', color: 'from-green-200 to-green-300', frameColor: 'border-gray-900' },
              { name: 'Dior', color: 'from-purple-200 to-purple-300', frameColor: 'border-gray-900' },
              { name: 'Chanel', color: 'from-gray-200 to-gray-300', frameColor: 'border-gray-900' }
            ].map((brand, i) => (
      ...
      <div className="bg-white py-12 md:py-16 lg:py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
            ...
            {[
              { name: 'PRADA VPR A04V', price: '13500', color: 'border-gray-900', badges: ['Premium'] },
              { name: 'DOLCE & GABBANA DG3361', price: '12500', color: 'border-gray-900', badges: ['New', 'Premium'] },
              { name: 'GUCCI GG14240', price: '13500', color: 'border-gray-900', badges: ['New', 'Premium'] },
              { name: 'AMORE 1676', price: '1800', color: 'border-amber-700' },
              { name: 'ROMY 5217', price: '2000', color: 'border-amber-700', badges: ['New'] },
              { name: 'EMBER 1007', price: '2500', color: 'border-gray-400', badges: ['New'] }
            ].map((p, i) => (
              <div key={i} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300">
                <div className="relative bg-gray-50 p-6">
                  ...
                  <div className="flex justify-center mt-4">
                    <div className={`w-6 h-6 ${p.color.includes('amber') ? 'bg-amber-700' : p.color.includes('gray-900') ? 'bg-gray-900' : 'bg-gray-400'} rounded-full border-2 border-gray-300`}></div>
                  </div>
                  {p.badges && (
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-sm">
              ...
              >
                <span className="font-bold text-gray-900 text-base md:text-lg">Stylish Eyeglasses for Women in Pakistan</span>
              ...
              {openAccordion === 0 && (
                <div className="px-6 pb-6 text-gray-700 text-sm md:text-base leading-relaxed">
                  <p>
                    Content for Stylish Eyeglasses for Women in Pakistan will go here.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm">
              <button 
                ...
                className="w-full px-6 py-4 flex items-center justify-between text-left hover:bg-gray-50 transition-colors"
              >
                <span className="font-bold text-gray-900 text-base md:text-lg">Designer Glasses Frames for Girls</span>
                <ChevronDown className={`w-5 h-5 text-gray-600 transition-transform ${openAccordion === 1 ? 'rotate-180' : ''}`} />
              </button>
              {openAccordion === 1 && (
                <div className="px-6 pb-6 text-gray-700 text-sm md:text-base leading-relaxed">
                  <p>
                    Content for Designer Glasses Frames for Girls will go here.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm">
              <button 
                ...
                className="w-full px-6 py-4 flex items-center justify-between text-left hover:bg-gray-50 transition-colors"
              >
                <span className="font-bold text-gray-900 text-base md:text-lg">Trendy Eyewear Collection for Women</span>
                <ChevronDown className={`w-5 h-5 text-gray-600 transition-transform ${openAccordion === 2 ? 'rotate-180' : ''}`} />
              </button>
              {openAccordion === 2 && (
                <div className="px-6 pb-6 text-gray-700 text-sm md:text-base leading-relaxed">
                  <p>
                    Content for Trendy Eyewear Collection for Women will go here.
                  </p>
                </div>
              )}
            </div>
